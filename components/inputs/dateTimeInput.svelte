<script lang="ts">
	import { DATE_FORMAT, DATE_TIME_FORMAT } from '$lib/mylib/data/pocketUtils';
    ...
    export let id: string = `time_${Math.random().toString(36).substring(2, 9)}`;
    ...
    $: internalValue = value ? moment(value).utc(true).format(DATE_TIME_FORMAT) : undefined;
